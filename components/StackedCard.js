...
function StackedCard() {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-right overflow-hidden text-white py-28 bg-purple bg-no-repeat bg-right-top bg-ST-pattern font-Poppins">
