...
function HeroSection() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center lg:pt-64 sm:pt-48 min-h-screen text-center bg-left-bottom bg-16 bg-no-repeat bg-hero-pattern -mb-32">
