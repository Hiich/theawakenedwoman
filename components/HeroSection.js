...
function HeroSection() {
	...
	return (
		<>
		<div className="flex flex-col items-center justify-center min-h-screen text-center bg-left-bottom bg-no-repeat bg-hero-pattern bg-16 pt-38">
		<h1 className="text-6xl font-normal lg:text-headerText tracking-headerSpace font-V-Bold">
			{data.Hero_Title} 
		</h1>
